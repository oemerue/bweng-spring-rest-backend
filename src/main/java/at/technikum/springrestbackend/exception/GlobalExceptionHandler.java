...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNotReadable(HttpServletRequest req) {
        HttpStatus status = HttpStatus.BAD_REQUEST;
        return ResponseEntity.status(status)
                .body(apiError(status, "Malformed JSON request or missing body", req));
    }
    ...
    public ResponseEntity<ApiError> handleUnauthorized(HttpServletRequest req) {
    ...
    public ResponseEntity<ApiError> handleDisabled(HttpServletRequest req) {
    ...
    public ResponseEntity<ApiError> handleConflict(HttpServletRequest req) {
        HttpStatus status = HttpStatus.CONFLICT;
        return ResponseEntity.status(status)
                .body(apiError(
                        status,
                        "Conflict: data violates a database constraint (e.g., duplicate value)",
                        req
                ));
    }
